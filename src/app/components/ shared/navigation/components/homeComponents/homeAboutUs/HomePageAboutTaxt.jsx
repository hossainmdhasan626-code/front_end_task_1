  ...
  return (
    ...
    >
      ...
      <div className="text-center md:text-left">
        <p
          className="font-figtree font-bold text-[36px] md:text-[72px] 
        text-dark-blue-color"
        >
          About Us
        </p>
        <p className="font-figtree font-medium md:font-semibold text-[22px] 
        md:text-[32px] text-primary-color">
          PRO HEALTH
        </p>
      </div>

      {/* description */}
      <div className="flex gap-5 w-full md:w-[596px] h-auto md:h-[317px]">
        {/* arrowSvg */}
        ...
        {/* descriptionTitle */}
        <div>
          <p className="font-figtree font-normal text-[22px] md:text-[32px] text-dark-blue-color
      ...
      >
        <p>
          We are professional diagnostic service provider committed to
          delivering accurate blood testss and reliable body check-ups . Our
          goal is to help individuals make informed health decisions through
          trustworthy medical testing and modern diagnostic solutions .
        </p>
        <p>
          With a focus on quality , safety, and customer care, we ensure every
          pataient receives professional service in a clean and well-managed
          enironment.
        </p>
      </div>
    </div>
...
export default HomePageAboutTaxt;
